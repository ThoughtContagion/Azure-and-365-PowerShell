<#
.SYNOPSIS
    Restrict Microsoft Azure Active Directory PowerShell access.
.DESCRIPTION
    This script configures the recommended restrictions to secure access to Microsoft Azure Active Directory PowerShell modules.  
.COMPONENT
...
.FUNCTIONALITY
    Restrict Microsoft Azure Active Directory PowerShell access to only approved roles and users.
#>
...
Function Restrict-AADPS {
    #Define the application by specifying the appId
    #Microsoft Azure Active Directory - 1b730954-1685-4b74-9bfd-dac224a7b894
